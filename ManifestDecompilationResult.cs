...
{
    /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/header"/>
    [Serializable]
    public sealed class ManifestDecompilationResult
    {
        #region Constructors
        internal ManifestDecompilationResult(string AppName, int BackgroundColor, bool LightForegroundText, bool ShowNameOnSquare150x150Logo, byte[] Square70x70LogoData, byte[] Square150x150LogoData, string Square70x70LogoName, string Square150x150LogoName, string Square70x70LogoFormat, string Square150x150LogoFormat, string Square70x70LogoDirectoryPath, string Square150x150LogoDirectoryPath)
        {
            mAppName = AppName;
        ...
        #region Properties
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='AppName']/*"/>
        public string AppName { get { return mAppName; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='BackgroundColor']/*"/>
        public int BackgroundColor { get { return mBackgroundColor; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='LightForegroundText']/*"/>
        public bool LightForegroundText { get { return mLightForegroundText; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='ShowNameOnSquare150x150Logo']/*"/>
        public bool ShowNameOnSquare150x150Logo { get { return mShowNameOnSquare150x150Logo; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square70x70LogoData']/*"/>
        public byte[] Square70x70LogoData { get { return mSquare150x150LogoData; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square150x150LogoData']/*"/>
        public byte[] Square150x150LogoData { get { return mSquare70x70LogoData; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square70x70LogoName']/*"/>
        public string Square70x70LogoName { get { return mSquare70x70LogoName; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square150x150LogoName']/*"/>
        public string Square150x150LogoName { get { return mSquare150x150LogoName; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square70x70LogoFormat']/*"/>
        public string Square70x70LogoFormat { get { return mSquare70x70LogoFormat; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square150x150LogoFormat']/*"/>
        public string Square150x150LogoFormat { get { return mSquare150x150LogoFormat; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square70x70LogoDirectoryPath']/*"/>
        public string Square70x70LogoDirectoryPath { get { return mSquare70x70LogoDirectoryPath; } }
        /// <include file=".Docs/.ManifestDecompilationResult.xml" path="docs/property[@name='Square150x150LogoDirectoryPath']/*"/>
