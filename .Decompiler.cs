...
namespace KamilSzymborski.VisualElementsManifestRT
{
    ...
    {
        #region Methods
        internal static ManifestRTDecompilationResult Decompile(ManifestRT ManifestRT)
        {
            ...
            return new ManifestRTDecompilationResult(BackgroundColor, LightForegroundText, ShowNameOnSquare150x150Logo, Square70x70LogoData, Square150x150LogoData, Square70x70LogoName, Square150x150LogoName, Square70x70LogoFormat, Square150x150LogoFormat, Square70x70LogoDirectoryPath, Square150x150LogoDirectoryPath);
        }
        #endregion
    }
}